...
namespace CounterStateful.Client
{
    ...
    {
        private const string ApplicationName = "fabric:/CounterStateful";

        public static void Main(string[] args)
        {
            var counter = ActorProxy.Create<ICounterActor>(new ActorId("COUNTER-2"), //Actor Id
                ApplicationName);
            ...
            for (;;)
            {
                var value = counter.GetCountAsync().Result;
